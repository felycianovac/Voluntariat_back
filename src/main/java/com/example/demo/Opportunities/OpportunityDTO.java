...
public class OpportunityDTO {
    ...
    private UserDTO3 approvedBy;
    private Date approvalDate;


    public static OpportunityDTO fromEntity(Opportunities opportunity) {
        return OpportunityDTO.builder()
                ...
                .approvedBy(opportunity.getApprovedBy() != null ? UserDTO3.fromEntity(opportunity.getApprovedBy()) : null)
